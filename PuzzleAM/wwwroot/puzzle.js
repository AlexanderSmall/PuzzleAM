...
function drawPiecePath(ctx, w, h, top, right, bottom, left, offset) {
    ...
    if (top === 0) {
        ...
        const endAngle = dir === 1 ? 2 * Math.PI : Math.PI;
        const anticlockwise = dir === -1;
        ctx.lineTo(startX, offset);
        ctx.lineTo(startX, offset - neck * dir);
        ctx.arc(centerX, offset - neck * dir, radius, startAngle, endAngle, anticlockwise);
    ...
    if (right === 0) {
        ...
        const endAngle = dir === 1 ? Math.PI / 2 : -Math.PI / 2;
        const anticlockwise = dir === -1;
        ctx.lineTo(offset + w, startY);
        ctx.lineTo(offset + w + neck * dir, startY);
        ctx.arc(offset + w + neck * dir, centerY, radius, startAngle, endAngle, anticlockwise);
    ...
    if (bottom === 0) {
        ...
        ctx.arc(centerX, offset + h + neck * dir, radius, startAngle, endAngle, anticlockwise);
    ...
    if (left === 0) {
        ...
        ctx.arc(offset - neck * dir, centerY, radius, startAngle, endAngle, anticlockwise);
